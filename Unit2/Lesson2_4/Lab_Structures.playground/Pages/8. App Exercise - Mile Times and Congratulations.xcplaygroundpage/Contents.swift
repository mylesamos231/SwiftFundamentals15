...
var totalRun = RunningWorkout(distance: 1300, time: 12, elevation: 50)
print(totalRun.averageMileTime)
/*:
...
var stepsCompletion = Steps(steps: 9999, goal: 10000)
stepsCompletion.takeStep()
