...
var favoriteBook = Book(title: "Diary of a Wimpy Kid", author: "Jeff Kenny", pages: 217, price: 19.99)

print("My favorite book is called \(favoriteBook.title), written by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs $\(favoriteBook.price)")
 ...
 */
struct Laptop {
    var screenSize: Int = 13 // Default value of 13
    var repairCount: Int = 0 // Default value of 0
    var yearPurchased: Int   // No default value
}

// Instance 1: Using the default values for screenSize and repairCount
var laptop1 = Laptop(yearPurchased: 2020)

// Instance 2: Providing custom values for all properties
var laptop2 = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2018)

// Print details of laptop1
print("Laptop 1 - Screen Size: \(laptop1.screenSize), Repair Count: \(laptop1.repairCount), Year Purchased: \(laptop1.yearPurchased)")

// Print details of laptop2
print("Laptop 2 - Screen Size: \(laptop2.screenSize), Repair Count: \(laptop2.repairCount), Year Purchased: \(laptop2.yearPurchased)")
/*:
