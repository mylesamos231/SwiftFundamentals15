...
friends = 32 // the line will cause an error 
...
print("No,Because A constant declared with 'let' cannot be changed after it is initialized. Attempting to change 'friends' would cause a compile-time error.")
